...
public class UsuarioModel {
    ...
    public int getPuntos_fidelizacion() { return puntos_fidelizacion; }
    public void setPuntos_fidelizacion(int puntos_fidelizacion) { this.puntos_fidelizacion = puntos_fidelizacion; }
    ...
    public TarjetaModel getTarjeta() { return tarjeta; }
    public void setTarjeta(TarjetaModel tarjeta) {
        this.tarjeta = tarjeta;
        if (tarjeta != null && tarjeta.getUsuario() != this) {
